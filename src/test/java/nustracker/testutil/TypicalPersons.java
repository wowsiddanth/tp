...
public class TypicalPersons {
    ...
    public static final Student ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94822248")
            .withYear("3")
            .withMajor("CS")
            .withNusNetId("e9831818")
            .withEmail("werner@example.com").build();
    public static final Student FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("94824271")
            .withYear("4")
            .withMajor("CS")
            .withNusNetId("e9192390")
            .withEmail("lydia@example.com").build();
    public static final Student GEORGE = new PersonBuilder().withName("George Best").withPhone("94824112")
            .withYear("2")
            .withMajor("IS")
