...
public class CommandTestUtil {
    ...
    public static final String INVALID_YEAR_DESC = " " + PREFIX_YEAR + "a"; //letters not allowed
    public static final String INVALID_MAJOR_DESC = " " + PREFIX_MAJOR + "computer science"; //use abbreviation, not ff
    public static final String INVALID_NUSNETID_DESC = " " + PREFIX_NUSNETID + "e123123123"; //e and 7 digits
