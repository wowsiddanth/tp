...
* However, commands that take in parameters cannot contain extraneous prefixes nor backslashes.

* This means none of the input parameters should contain any backslashes, since backslashes are used to identify prefixes.
...
- Event name cannot contain the backslash character as backslashes are used to identify prefixes.
